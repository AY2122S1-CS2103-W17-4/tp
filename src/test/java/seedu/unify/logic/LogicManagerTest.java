...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonUniFyStorage addressBookStorage =
                new JsonUniFyStorage(temporaryFolder.resolve("addressBook.json"));
     ...
     */
    private static class JsonUniFyIoExceptionThrowingStub extends JsonUniFyStorage {
        private JsonUniFyIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
